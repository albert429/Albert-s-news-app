...
public class QueryUtils {
    ...
    static String createStringUrl() {
        return "https://content.guardianapis.com/search?q=debate&tag=politics/politics&from-date=2014-01-01&api-key=test";
    }
    ...
    static List<News> parseJson(String response) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                listOfNews.add(new News(webTitle,section,date,author,url));
            }
